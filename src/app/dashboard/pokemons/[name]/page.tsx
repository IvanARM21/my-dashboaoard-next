...
export async function generateMetadata({params} : Props) : Promise<Metadata> {
  try {
    ...
    return {
      title: 'Página del pokénmon',
      description: 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Corporis rem reprehenderit accusantium alias soluta eligendi est iure excepturi quasi error. Nemo, mollitia? Iste necessitatibus ipsam in eligendi sequi ullam ab.'
    }
  }
}
